        ...
        <section className={`${Spirit.page.xl} grid-12`}>
            ...
            >
                ...
                <p className={`${Spirit.small} midgrey mt1`}>
                    Spend less time running your servers and more time running your site.
                    <strong className="blue">Ghost(Pro)</strong> has got you covered.
                </p>
            </a>
            ...
            >
                ...
                <p className={`${Spirit.small} midgrey mt1`}>
                    Join the <strong>Ghost community</strong> and meet thousands of other
                    professional users and developers now
                </p>
            </a>
        </section>
            ...
            <div className="bt b--whitegrey flex justify-between items-center pt4">
                <ul className="flex list pa0 ma0 items-center">
                    <li className={listItemClass}>
                        <a href="https://ghost.org" className="dib pt2 mr6">
                            <Logo />
                        </a>
                    </li>
                    ...
                    <li className={`${listItemClass} dn db-l`}>
                        <a href="https://forum.ghost.org" className={linkClass}>
                            Forum
                        </a>
                    </li>
                    <li className={`${listItemClass} dn db-l`}>
                        <a href="https://status.ghost.org" className={linkClass}>
                            Status
                        </a>
                    </li>
                    <li className={`${listItemClass} dn db-l`}>
                        <a href="https://twitter.com/tryghost" className={linkClass}>
                            @TryGhost
                        </a>
                    </li>
                </ul>
                ...
                <ul className="flex list pa0 ma0 items-center">
                    <li className={listItemClass}>
                        <a href="https://ghost.org" className="link pa2 midgrey hover-blue dib mr0">
                            Ghost.org
                        </a>
                    </li>
                </ul>
