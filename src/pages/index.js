                    ...
                    <div className={`${Spirit.page.xl} grid-12 gutter-row-20 gutter-40-ns`}>
                        ...
                        <section className="col-12 col-6-ns mt0-ns bt bn-ns b--whitegrey nl5 nr5 nl0-ns nr0-ns ml0-ns mr0-ns pl5 pr5 pl0-ns pr0-ns pt5 pt0-ns ">
                            ...
                            <div className="mt3 mt7-ns">
                                <HomeFAQLink
                                    to="/faq/upgrade-to-ghost-2-0/"
                                    title="Upgrade to Ghost 2.0"
                                >
                                    Ghost 2.0 was released in September 2018 and the second major
                                    upgrade since the platform launched. Learn how to upgrade
                                </HomeFAQLink>
                    ...
                    >
                        ...
                        <div className="grid-integrations-index mt4 mt6-l f8">
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/zapier.png"
                                    alt="Zapier"
                                />
                                Zapier
                            </Box>
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/disqus.svg"
                                    alt="Disqus"
                                />
                                Disqus
                            </Box>
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/slack.png"
                                    alt="Slack"
                                />
                                Slack
                            </Box>
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/unsplash.svg"
                                    alt="Unsplash"
                                />
                                Unsplash
                            </Box>
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/google-analytics-1.png"
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/mailchimp.png"
                                    alt="Mailchimp"
                                />
                                Mailchimp
                            </Box>
                            ...
                            >
                                <img
                                    className="w10 mb1"
                                    src="https://res.cloudinary.com/tryghost/image/fetch/w_120,h_100,c_fit/https://docs.ghost.io/content/images/2018/09/amp.jpg"
                                    alt="Google AMP"
                                />
                                Google AMP
                            </Box>
